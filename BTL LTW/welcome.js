...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const exams = [
        { name: "Kỳ thi luyện tập", status: "open" },
...
// Lắng nghe sự kiện khi người dùng nhấn vào nút "Bắt đầu" trong phần "Kỳ thi luyện tập"
const startButtonLuyenTap = document.querySelector('#examsList .exam:nth-child(1) .start-btn');
    startButtonLuyenTap.addEventListener("click", function() {
